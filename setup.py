...
setup(
    ...
    name = 'ehb-client',
    author = 'Aaron Masino',
    author_email = 'aaronmasino@gmail.com',
    description = 'ehb client application',
    license = 'GPL',
    keywords = 'HTTP informatics bioinformatics',
    ...
    classifiers = [
        ...
        'Topic :: Internet :: WWW/HTTP :: Informatics :: Bioinformatics',
    ],
)
